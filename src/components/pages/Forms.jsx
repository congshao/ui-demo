                ...
                <form action="http://ecreditpal.herokuapp.com/new_accounts">
                    ...
                    <div className="row">
                        <div className="col-sm-4">
                            <label>姓名</label>
                            <input height="70" id="first_name" maxlength="20" className="form-control text_field to_save_input required_field first_name_field" placeholder="" type="text"/>
                        </div>
                        <div className="col-sm-4">
                            <label>身份证号</label>
                    ...
                    <div className="row">
                        ...
                        <div className="row">
                            <div className="col-sm-4" >
                                <label>年份</label>
                                <input id="first_name" maxlength="10" className="form-control text_field to_save_input required_field first_name_field" placeholder="" type="text"/>
                            </div>
                            <div className="col-sm-4">
                                <label>月份</label>
                                <input id="first_name" maxlength="5" className="form-control text_field to_save_input required_field first_name_field" placeholder="" type="text"/>
                            </div>
                            <div className="col-sm-4">
                                <label>日</label>
                                <input id="first_name" maxlength="5" className="form-control text_field to_save_input required_field first_name_field" placeholder="" type="text"/>
